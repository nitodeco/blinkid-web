...
export default {
  ...
  front_side_scanned: "Front side scanned",
  back_side_scanned: "Back side scanned",
  ...
  camera_angle_too_steep: "Keep document parallel with phone",
  ...
  document_not_recognized_details:
    "Scan the front side of a supported document.",
